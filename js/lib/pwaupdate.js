                    ...
                    if (e.indexOf(s) >= 0) {
                        ...
                        for (let e = 0; e < a; e++) {
                            ...
                            if ("" === n) i = l();
                                ...
                                const t = d.exec(n);
                                null !== t && o(t[2], "$lit$") && (n = n.slice(0, t.index) + t[1] + t[2].slice(0, -"$lit$".length) + t[3]), i = document.createTextNode(n)
                            }
                        ...
                        "" === r[a] ? (s.insertBefore(l(), t), i.push(t)) : t.data = r[a], c += a
                    }
                } else if (8 === t.nodeType)
                    if (t.data === s) {
                        const e = t.parentNode;
                        null !== t.previousSibling && p !== h || (p++, e.insertBefore(l(), t)), h = p, this.parts.push({
                            type: "node",
                            index: p
                        }), null === t.nextSibling ? t.data = "" : (i.push(t), p--), c++
                    } else {
                        let e = -1;
...
function h(t, e) {
    ...
    for (; n.nextNode();) {
        ...
        for (t.previousSibling === h && (h = null), e.has(t) && (d.push(t), null === h && (h = t)), null !== h && l++; void 0 !== o && o.index === a;) o.index = null !== h ? -1 : o.index - l, r = c(i, r), o = i[r]
    }
...
class y {
    ...
    _clone() {
        ...
        for (; o < i.length;)
            if (r = i[o], a(r)) {
                for (; l < r.index;) l++, "TEMPLATE" === d.nodeName && (s.push(d), n.currentNode = d.content), null === (d = n.nextNode()) && (n.currentNode = s.pop(), d = n.nextNode());
                if ("node" === r.type) {
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const _ = window.trustedTypes && trustedTypes.createPolicy("lit-html", {
        createHTML: t => t
    }),
    v = ` ${s} `;
class w {
    ...
    getHTML() {
        ...
        for (let r = 0; r < t; r++) {
            ...
            const a = d.exec(t);
            e += null === a ? t + (n ? v : i) : t.substr(0, a.index) + a[1] + a[2] + "$lit$" + a[3] + s
        }
...
class P {
    ...
    setValue(t) {
        t === m || S(t) && t === this.value || (this.value = t, f(t) || (this.committer.dirty = !0))
    }
    commit() {
        for (; f(this.value);) {
            const t = this.value;
...
class T {
    ...
    commit() {
        ...
        const t = this.__pendingValue;
        t !== m && (S(t) ? t !== this.value && this.__commitText(t) : t instanceof w ? this.__commitTemplateResult(t) : t instanceof Node ? this.__commitNode(t) : b(t) ? this.__commitIterable(t) : t === g ? (this.value = g, this.clear()) : this.__commitText(t))
    }
    __insert(t) {
    ...
    __commitIterable(t) {
        ...
        const e = this.value;
        let s, i = 0;
        for (const n of t) s = e[i], void 0 === s && (s = new T(this.options), e.push(s), 0 === i ? s.appendIntoPart(this) : s.insertAfterPart(e[i - 1])), s.setValue(n), s.commit(), i++;
...
class N {
    ...
    commit() {
        ...
        const t = !!this.__pendingValue;
        this.value !== t && (t ? this.element.setAttribute(this.name, "") : this.element.removeAttribute(this.name), this.value = t), this.__pendingValue = m
    }
}
class C extends x {
    constructor(t, e, s) {
...
class k {
    ...
    commit() {
        ...
        const t = this.__pendingValue,
            ...
            i = null != t && (null == e || s);
        s && this.element.removeEventListener(this.eventName, this.__boundHandleEvent, this.__options), i && (this.__options = U(t), this.element.addEventListener(this.eventName, this.__boundHandleEvent, this.__options)), this.value = t, this.__pendingValue = m
    }
    handleEvent(t) {
...
const I = t => e => {
        ...
        if (o = n.keyString.get(a), void 0 === o) {
            ...
            j && window.ShadyCSS.prepareTemplateDom(s, t), o = new r(e, s), n.keyString.set(a, o)
        }
    ...
    F = (t, e, s) => {
        ...
        s ? function(t, e, s = null) {
            ...
            let o = c(n),
                ...
                l = -1;
            for (; r.nextNode();)
                for (l++, r.currentNode === s && (a = p(e), s.parentNode.insertBefore(e, s)); - 1 !== o && n[o].index === l;) {
                    if (a > 0) {
...
class D extends HTMLElement {
    ...
    requestUpdateInternal(t, e, s) {
        ...
        if (void 0 !== t) {
            ...
            s = s || n.getPropertyOptions(t), n._valueHasChanged(this[t], e, s.hasChanged) ? (this._changedProperties.has(t) || this._changedProperties.set(t, e), !0 !== s.reflect || 16 & this._updateState || (void 0 === this._reflectingProperties && (this._reflectingProperties = new Map), this._reflectingProperties.set(t, s))) : i = !1
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const J = (t, e) => "method" === e.kind && e.descriptor && !("value" in e.descriptor) ? Object.assign(Object.assign({}, e), {
    finisher(s) {
...
*/
const K = window.ShadowRoot && (void 0 === window.ShadyCSS || window.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype,
    Y = Symbol();
class Z {
    constructor(t, e) {
...
class tt extends D {
    ...
    adoptStyles() {
        ...
        0 !== t.length && (void 0 === window.ShadyCSS || window.ShadyCSS.nativeShadow ? K ? this.renderRoot.adoptedStyleSheets = t.map((t => t instanceof CSSStyleSheet ? t : t.styleSheet)) : this._needsShimAdoptedStyleSheets = !0 : window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map((t => t.cssText)), this.localName))
    }
    connectedCallback() {
    ...
    update(t) {
        const e = this.render();
        super.update(t), e !== X && this.constructor.render(e, this.renderRoot, {
...
tt.finalized = !0, tt.render = (t, s, i) => {
    ...
    if (((t, s, i) => {
            let n = R.get(s);
            void 0 === n && (e(s, s.firstChild), R.set(s, n = new T(Object.assign({
                templateFactory: O
            }, i))), n.appendInto(s)), n.setValue(t), n.commit()
        })(t, l, Object.assign({
            templateFactory: I(n)
        }, i)), a) {
        const t = R.get(l);
...
var et = function(t, e, s, i) {
    ...
    if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) o = Reflect.decorate(t, e, s, i);
        ...
        for (var a = t.length - 1; a >= 0; a--)(n = t[a]) && (o = (r < 3 ? n(o) : r > 3 ? n(e, s, o) : n(e, s)) || o);
...
let st = class extends tt {
    ...
    async firstUpdated() {
        ...
        if (this.swpath && "serviceWorker" in navigator) {
            ...
            if (s.installing && navigator.storage) {
                ...
                if (s) {
                    this.storageUsed = this.formatBytes(s.usage), this.showOfflineToast = !0, await this.updateComplete;
                    const i = null === (e = null === (t = this.shadowRoot) || void 0 === t ? void 0 : t.querySelector("#storageToast")) || void 0 === e ? void 0 : e.animate([{
                        opacity: 0
                    }, {
                        opacity: 1
                    }], {
            ...
            s.onupdatefound = async () => {
                let t = s.installing;
                t && (t.onstatechange = () => {
                    "installed" === (null == t ? void 0 : t.state) && this.dispatchEvent(new Event("pwaUpdate"))
                })
            }
        }
        this.setupEvents()
    ...
    doUpdate() {
        var t, e;
        null === (e = null === (t = this.swreg) || void 0 === t ? void 0 : t.waiting) || void 0 === e || e.postMessage({
